...
ennemie initialiser_ennemie(ennemie e)
{
 ...
 e.pos.w=137;
 e.pos.h=64;
/*loading image of walking 00 11  left 0 1 right */
 e.tab[0] = IMG_Load("00.png");

 e.tab[1] = IMG_Load("11.png");

 e.tab[2] = IMG_Load("0.png");

 e.tab[3] = IMG_Load("1.png");

/* loading image of running 22 33 left */
 e.tab2[0] = IMG_Load("22.png");

 e.tab2[1] = IMG_Load("33.png");
